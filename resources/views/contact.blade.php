                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Hello! Why are you contacting us
                                        today?</label>
                            ...
                            <div class="col-lg-4">
                                ...
                                <ul class="list-unstyled ">
                                    <li class="mb-3">1. We can only address issues related to themefisher.com. We are
                                        not affiliated with the sites we write about.</li>

                                    <li class="mb-3"> 2. If you would like to submit news, please see the “Submit News
                                        to Form” page that has more details. </li>
